...
class TurkeyEntry extends StatefulWidget {
  @override
  TurkeyEntryState createState() => TurkeyEntryState();
}

class TurkeyEntryState extends State<TurkeyEntry> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                FirebaseFirestore.instance.collection('Turkeys').add({
