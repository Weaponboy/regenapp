...
class PigsEntry extends StatefulWidget {
  @override
  PigsEntryState createState() => PigsEntryState();
}

class PigsEntryState extends State<PigsEntry> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                FirebaseFirestore.instance.collection('Pigs').add({
