...
class Frost extends StatelessWidget {
  ...
  final TextEditingController frostController = TextEditingController();
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                FirebaseFirestore.instance.collection('Frost').add({
                  'Frost description': frostController.text,
                  'Date': dateController.text,
                });
                frostController.clear();
                dateController.text = DateFormat('yyyy-MM-dd').format(DateTime.now());
              },
              child: Text('Submit'),
            ),
